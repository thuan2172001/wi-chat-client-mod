...
function controller(api, auth, io) {
    ...
    function init() {
        ...
        api.getListConversation(token, { username: username }, function (resp) {
            ...
            var data = '{"content":"sadf","type":"text","idSender":13,"idConversation":13,"User":{"id":13,"username":"chat5","password":"=========================","role":2,"color":"#46CC12"},"sendAt":"2018-08-10T09:46:31.302Z"}';
...
//# sourceMappingURL=main.186e6ac5a4540785dd43.hot-update.js.map