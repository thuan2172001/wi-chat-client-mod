...
function controller(api, auth, io) {
    ...
    function init() {
        ...
        api.getListConversation(token, { username: username }, function (resp) {
            ...
            var data = '{"content":"sadf","type":"text","idSender":13,"idConversation":13,"User":{"id":13,"username":"chat6","password":"=========================","role":2,"color":"#46CC12"},"sendAt":"2018-08-10T09:46:31.302Z"}';
...
//# sourceMappingURL=main.1e0271e886684f8e8cf2.hot-update.js.map